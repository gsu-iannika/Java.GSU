...
public class WeatherWidget {
    ...
    public WeatherWidget(String city, String country, String iconId, String shortDescription, String extendedDescription, double temperature, double pressure, double humidity, double minTemperature, double maxTemperature, double windSpeed, double windDirection, double cloudiness) {
        this.city = city;
    ...
    public void saveWidgetHtml() {
        String widgetCode = getWidgetHtml();

        File fileHtml = new File("src/by/gsu/pms/Weather.html");
        try {
